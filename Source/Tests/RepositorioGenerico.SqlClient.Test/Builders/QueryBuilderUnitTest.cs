...
namespace RepositorioGenerico.SqlClient.Test.Builders
{
	...
	public class QueryBuilderUnitTest
	{
		...
		[TestMethod]
		public void SeCriarQueryBuilderDeveRetornarNovaInstanciaDeUmQueryBuilder()
		{
			var builder = new QueryBuilder();

			var novaInstancia = builder.Criar();

			builder
				.Should()
				.NotBeSameAs(novaInstancia);
		}


		[TestMethod]
		public void SeTestarAConsultaDosOperadoresGeraisDeveRetornarSinalValido()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeDefinirLimiteNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeDefinirTabelaNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeDefinirResultadoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeDefinirResultadoNaQueryDeUmCampoComAliasAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeDefinirResultadoPersonalizadoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeDefinirResultadoAgregadoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarAgrupamentoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarCondicaoAgrupamentoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarCondicaoPersonalizadaNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarCondicaoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarCondicaoNaoNuloNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarCondicaoEntreNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
			...
			builder.Wheres[0].Should().Be("([campoQueDeveSerValidado]between @_p0a and @_p0b)");
			builder.Wheres[1].Should().Be("([campoQueDeveSerValidado]>=@_p1a)");
			builder.Wheres[2].Should().Be("([campoQueDeveSerValidado]<=@_p2b)");
		...
		[TestMethod]
		public void SeAdicionarRelacionamentoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarOrdenacaoNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeAdicionarOrdenacaoDescendenteNaQueryAVariavelDeveSerDefinidaCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeGerarScriptSemDicionarioDeveGerarScriptCorretamente()
		{
			var builder = new QueryBuilder();
		...
		[TestMethod]
		public void SeGerarScriptsAPartirDeUmDicionarioDeveGerarScriptCorretamente()
		{
			var builder = new QueryBuilder();
